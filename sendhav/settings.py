"""
Django settings for sendhav project.
...
SECRET_KEY = 'k_1v-cfrw%u7#3)g^4&2*z@q9$+p5l4i)=nudmbb0=&yw@!1w&'
...
WSGI_APPLICATION = 'sendhav.wsgi.application'
